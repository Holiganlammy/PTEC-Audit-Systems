  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-130">
        <DialogHeader>
          <DialogTitle>
            {initialScore !== null ? "แก้ไขคะแนนสาขา" : "เพิ่มคะแนนสาขา"}
          </DialogTitle>
          <DialogDescription>
            {itemName ? (
              <span>
                {initialScore !== null ? "แก้ไข" : "เพิ่ม"}คะแนนสำหรับรายการ:{" "}
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="w-full">
          <div className="space-y-4 py-2">
            <Field
              data-invalid={!!form.formState.errors.score}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <RadioGroup
                      ...
                      onValueChange={(v) =>
                        field.onChange(
                          v === "" ? undefined : (Number(v) as ScoreValue),
                        )
                      }
                      className="gap-2"
