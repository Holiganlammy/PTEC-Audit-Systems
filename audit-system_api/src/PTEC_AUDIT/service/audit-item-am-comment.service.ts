...
@Injectable()
export class AuditItemAMCommentsService {
  constructor(
    @InjectRepository(AuditItemAMComment)
    private readonly amCommentsRepository: Repository<AuditItemAMComment>,
  ) {}

  // Create new AM comment
  async create(createDto: CreateCommentDto): Promise<AuditItemAMComment> {
  ...
  async findByItemId(itemId: number): Promise<AuditItemAMComment[]> {
  ...
  async findOne(id: number): Promise<AuditItemAMComment> {
  ...
  async findPendingByItemId(itemId: number): Promise<AuditItemAMComment[]> {
    return await this.amCommentsRepository.find({
  ...
  async findApprovedByItemId(itemId: number): Promise<AuditItemAMComment[]> {
    return await this.amCommentsRepository.find({
